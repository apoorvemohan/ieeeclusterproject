...
//  *address = (PIXEL *)valloc(length*sizeof(PIXEL));;
  ...
  posix_memalign(address, sizeof(PIXEL*), length*sizeof(PIXEL));
...
//  *address = (MPIXEL *)valloc(length*sizeof(MPIXEL));;
  ...
  posix_memalign(address, sizeof(MPIXEL *), length*sizeof(MPIXEL));
...
//  *address1 = (PIXEL *)valloc(length);;
  ...
  posix_memalign(address1, sizeof(PIXEL*), length*sizeof(PIXEL));
