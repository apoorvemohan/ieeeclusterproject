...
//  last_malloc = (double **) valloc(P*sizeof(double *));;
	...
	posix_memalign(&last_malloc, sizeof(double**), P*sizeof(double *));
...
//    last_malloc[i] = (double *) valloc(proc_bytes[i] + PAGE_SIZE);
	posix_memalign(&last_malloc[i], sizeof(double *),proc_bytes[i] + PAGE_SIZE );
...
//  a = (double **) valloc(nblocks*nblocks*sizeof(double *));;
	...
	posix_memalign(&a, sizeof(double **), nblocks*nblocks*sizeof(double *));
...
//  rhs = (double *) valloc(n*sizeof(double));;
	...
	posix_memalign(&rhs, sizeof(double*), n*sizeof(double));
...
posix_memalign(&Global->t_in_fac ,sizeof(double *) ,(P*sizeof(double)));
posix_memalign(&Global->t_in_mod ,sizeof(double *) ,(P*sizeof(double)));
posix_memalign(&Global->t_in_solve ,sizeof(double *) ,(P*sizeof(double)));
posix_memalign(&Global->t_in_bar ,sizeof(double *) ,(P*sizeof(double)));
posix_memalign(&Global->completion ,sizeof(double *) ,(P*sizeof(double)));
